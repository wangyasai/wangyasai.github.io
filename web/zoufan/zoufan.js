...
function preload() {
  song = loadSound('../web/zoufan.mp3');
  data = loadTable("../web/data/sentiment_by_hour.csv","header");
}
...
function legend(){
  ...
  noStroke()
  fill(48,58,93, 150);
  text("一小时内微博发布数量", padding+ 40, 60) ;     
  text("情绪值", padding+ 40, 90) ;    
